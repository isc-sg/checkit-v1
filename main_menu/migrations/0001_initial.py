# Generated by Django 4.2.4 on 2025-06-10 08:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('light_level_threshold', models.DecimalField(decimal_places=2, default=0.5, max_digits=3, validators=[django.core.validators.MaxValueValidator(1), django.core.validators.MinValueValidator(0)])),
                ...
                ('freeze_check', models.BooleanField(default=False, help_text='Set to true to check if previous log image is identical')),
                ...
                ('psn_ip_address', models.GenericIPAddressField(blank=True, default=None, null=True, verbose_name='Video Storage IP Address')),
                ('psn_name', models.CharField(blank=True, default=None, max_length=20, null=True, verbose_name='Video Storage Name')),
                ('psn_recorded_port', models.PositiveIntegerField(blank=True, default=None, null=True, verbose_name='Video Storage Port Number')),
                ('psn_user_name', models.CharField(blank=True, max_length=255, null=True, verbose_name='Video Storage User Name')),
                ('psn_password', models.CharField(blank=True, default=None, max_length=255, null=True, verbose_name='Video Storage Password')),
                ('psn_api_method', models.BooleanField(default=False, help_text='Set to true to use API method for reading from Video Storage')),
            ],
        ),
        migrations.CreateModel(
            name='DaysOfWeek',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_matching_score', models.DecimalField(decimal_places=2, default=0, max_digits=3)),
                ('new_focus_value', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=3, null=True)),
                ('new_light_level', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=3, null=True)),
                ('current_regions', models.JSONField(default=list)),
                ('current_matching_score', models.DecimalField(decimal_places=2, default=0, max_digits=3)),
                ('current_focus_value', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=3, null=True)),
                ('current_light_level', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=3, null=True)),
                ('accepted', models.BooleanField(default=True)),
                ('url', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='main_menu.camera', verbose_name='Camera Name and Number')),
            ],
        ),
        migrations.CreateModel(
            name='ReferenceImage',
            fields=[
                ...
                ('light_level', models.DecimalField(decimal_places=2, default=0, max_digits=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_name', models.ForeignKey(blank=True, db_constraint=False, default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='main_menu.group', verbose_name='Group Name')),
        ...
        migrations.AddField(
            model_name='camera',
            name='group_name',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='main_menu.group', verbose_name='Group Name'),
        ),
        migrations.AddField(
            model_name='camera',
            name='scheduled_days',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('light_level', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=3, null=True)),
                ('current_light_level', models.DecimalField(decimal_places=2, default=0, max_digits=3)),
            ...
            options={
                'indexes': [models.Index(fields=['creation_date', 'action', 'run_number'], name='main_menu_l_creatio_22d58b_idx')],
            },
        ),
    ]
